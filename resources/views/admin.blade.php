...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/template/dataTables.bootstrap4.css')}}">

    <!-- Custom styles for this template-->
    <link rel="stylesheet" href="{{asset('css/template/sb-admin.css')}}">
...
<script src="{{asset('js/template/jquery.dataTables.js')}}"></script>
<script src="{{asset('js/template/dataTables.bootstrap4.js')}}"></script>


<!-- Custom scripts for all pages-->
<script src="{{asset('js/template/sb-admin.min.js')}}"></script>


<!-- Demo scripts for this page-->
<script src="{{asset('js/template/datatables-demo.js')}}"></script>
<script src="{{asset('js/template/chart-area-demo.js')}}"></script>
